...
export const metadata = {
  title: "The Restarter | Proof & Practice",
  description: "You've been trying. The system underneath the trying hasn't been built yet.",
  openGraph: {
    title: "The Restarter | Proof & Practice",
    description: "You've been trying. The system underneath the trying hasn't been built yet.",
    siteName: "Proof & Practice",
    type: "website",
    images: [{ url: "/api/og", width: 1200, height: 630, alt: "The Restarter | Proof & Practice" }],
  },
  twitter: {
